...
@section('title', 'Diplomado en Evaluación Formativa - Postgrado en Educación')
@section('description', 'Gestiona eficientemente la evaluación formativa para el aprendizaje de estudiantes en el marco del enfoque por competencias con nuestro diplomado especializado.')

@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-r from-purple-900 via-purple-800 to-pink-900 text-white py-16">
    ...
    <div class="relative container mx-auto px-4">
        <div class="max-w-4xl">
            <h1 class="text-4xl lg:text-5xl font-bold leading-tight mb-6">
                Diplomado en 
                <span class="text-yellow-400">Evaluación Formativa</span>
            </h1>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm text-purple-200">INICIO</span>
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm text-purple-200">DURACIÓN</span>
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm text-purple-200">HORAS</span>
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm text-purple-200">INVERSIÓN</span>
                    </div>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="text-lg text-gray-700 leading-relaxed">
                El Diplomado en Evaluación Formativa es un programa de formación que tiene como objetivo gestionar de forma eficiente la evaluación formativa para el aprendizaje de los estudiantes en el marco del enfoque por competencias en Educación Básica y Superior. Así mismo desarrollar estrategias de evaluación formativa en el aula que aseguren los aprendizajes de los estudiantes.
            </p>
        </div>
    </div>
</section>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        <div class="w-12 h-12 bg-purple-600 text-white rounded-full flex items-center justify-center font-bold mr-4 flex-shrink-0">
                            I
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-900">Módulo I</h4>
                            <p class="text-gray-700">Enfoque de la evaluación formativa.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Evaluación formativa en el CNEB.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Evaluación formativa: los criterios de evaluación.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">La retroalimentación en la evaluación formativa.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Instrumentos de evaluación.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Formación continua e innovadora como estrategia de aprendizaje.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Docentes de educación básica y superior, coordinadores académicos y directores de instituciones educativas.</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mr-2 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700">Formadores de docentes, consultores pedagógicos, especialistas de la UGEL y de las Direcciones Regionales de Educación.</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mr-2 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700">Profesionales interesados en la temática.</span>
                        </li>
                    </ul>
                </div>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid lg:grid-cols-3 gap-8">
                <div class="bg-gradient-to-br from-purple-50 to-pink-100 rounded-2xl p-8">
                    ...
                    <p class="text-xl font-semibold text-purple-800">4 meses</p>
                </div>
                
                <div class="bg-gradient-to-br from-pink-50 to-rose-100 rounded-2xl p-8">
                    <div class="flex items-center mb-4">
                        <svg class="w-8 h-8 text-pink-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/>
                        </svg>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-gray-700">
                            <span class="font-semibold">Sábado:</span> 8:00 - 13:00 horas
                        </p>
                    </div>
                </div>
                
                <div class="bg-gradient-to-br from-indigo-50 to-purple-100 rounded-2xl p-8">
                    <div class="flex items-center mb-4">
                    ...
                    <div class="space-y-3">
                        <p class="text-sm font-medium text-indigo-800 mb-3">Banco de la Nación y/o Caja de Pago UNAMAD</p>
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-bold text-indigo-800 text-lg">S/ 510.00</span>
                            </div>
                        </div>
