...
@section('title', 'Diplomado en Gestión Educativa - Postgrado en Educación')
@section('description', 'Desarrolla competencias gerenciales y directivas para la gestión de instituciones educativas con nuestro diplomado especializado.')
    ...
    <div class="relative container mx-auto px-4">
        <div class="max-w-4xl">
            <h1 class="text-4xl lg:text-5xl font-bold leading-tight mb-6">
                Diplomado en 
                <span class="text-yellow-400">Gestión Educativa</span>
            </h1>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm text-blue-200">INICIO</span>
                    </div>
                    <p class="text-lg font-semibold">19 de Julio, 2025</p>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm text-blue-200">HORAS</span>
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm text-blue-200">INVERSIÓN</span>
                    </div>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="text-lg text-gray-700 leading-relaxed">
                El Diplomado en Gestión Educativa es un programa de formación que tiene como objetivo capacitar contribuir al desarrollo y fortalecimiento de las competencias gerenciales y directivas de los directores, subdirectores y equipos de gestión de Instituciones Educativas, docentes y profesiones en ciencias sociales; asimismo, contribuir a la formación de profesionales en educación que deseen acceder a la gestión de los centros educativos para promover el desarrollo de capacidades de análisis, diagnóstico y síntesis en la toma de decisiones.
            </p>
        </div>
    </div>
</section>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-3xl font-bold text-gray-900 mb-12 text-center">Sobre el diplomado</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900">¿Por qué estudiar esta diplomatura?</h3>
                    </div>
                    <p class="text-gray-700 leading-relaxed">
                        La diplomatura tiene la finalidad de desarrollar las competencias vinculadas a la gestión, promoción y evaluación de organizaciones educativas escolares a través del conocimiento y la aplicación de herramientas de gestión pedagógica, institucional y administrativa desde la mirada de la gestión del conocimiento.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900">¿Qué lograré con esta diplomatura?</h3>
                    </div>
                    <p class="text-gray-700 leading-relaxed">
                        Se centra en la formación de tres áreas: la gestión institucional, la gestión pedagógica y la gestión administrativa.
                        <br><br>
                        Estas engloban las tareas que van a encaminar la institución educativa hacia un servicio de calidad; de allí la necesidad que tiene el directivo de conocer, estar actualizado, tener una mirada crítica y reflexiva que le permita tomar decisiones sobre las herramientas para gestionar la institución con eficiencia, ética y eficacia.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Directores, sub directores, autoridades académicas de instituciones educativas escolares públicas y privadas.</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mr-2 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700">Coordinadores y administrativos de instituciones educativas escolares públicas y privadas.</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mr-2 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700">Docentes y personas interesadas en la gestión de instituciones educativas escolares.</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Copia simple del grado de bachiller o título profesional del Instituto Superior Pedagógico.</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-blue-500 mr-2 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        <div class="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold mr-4 flex-shrink-0">
                            I
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-900">Módulo I</h4>
                            <p class="text-gray-700">Gestión de procesos y resultados de la institución educativa.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Procesos de gestión administrativa y/o de soporte.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Fundamentos para orientar la gestión pedagógica de la institución educativa.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Orientación de procesos pedagógicos para la mejora del aprendizaje.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Gestión de la persona humana, identidad docente, tutoría, convivencia escolar, vínculos: escuela, familia y comunidad.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6 flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Manejo de conflictos.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid lg:grid-cols-3 gap-8">
                <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
                    ...
                    <p class="text-xl font-semibold text-blue-800">4 meses</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-gray-700">
                            <span class="font-semibold">Domingo:</span> 8:00 - 13:00 horas
                        </p>
                    </div>
                </div>
